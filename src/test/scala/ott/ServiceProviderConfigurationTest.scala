...
import ott.reader.mycomponent.MyStreamReaderImpl
import ott.transformer.mycomponent.MyStreamTransformerImpl
import ott.writer.mycomponent.MyStreamWriterImpl
